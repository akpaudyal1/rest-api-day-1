...
public class EmployeeController {
	...
	public String registerEmployee(@ModelAttribute EmployeeDTO employeeDTO, Model model) {
		                           //@ModelAttribute ---> for reading all data (all data means --5 data-->employeeId,employeename,salary,emailId,password)
	...
	//Edit operation - step:1 (we want to get edit page and in that page respective data has also to be shown)
